...
def handle_client(conn, addr):
    ...
    while True:
        ...
        try:
            ...
            # Tanto enviar como postar somente alteram o arquivo .json
            if msg["tipo"] == "enviar" or msg["tipo"] == "postar":
                mensagens.append(msg)
                salvar_em_log(msg)
                conn.send(msgpack.packb({"status": "mensagem enviada!"}, use_bin_type=True))

            # Verifica se a origem e o destino para retornar o chat privado
            ...
            # Verifica o tipo de mensagem e a origem para retornar todas as postagens de um determinado usuário
